    ...
    return (
        <>
            <div className='w-screen h-screen flex flex-col items-center gap-2 pt-3 '>
                <form action="" className='shadow-lg flex flex-col gap-5 p-8 w-[350px] border '>
                    ...
                    <div>
                        <input type="email" name="email" id="" className=' my-2  focus-visible:border-gray-600 outline-none border-[1.6px] border-gray-400 w-full py-1.5 px-1.5 font-thin placeholder:font-normal placeholder:text-xs' placeholder='Mobile no or email address' />
                        <input type="text" name="username" id="" className=' my-2  focus-visible:border-gray-600 outline-none border-[1.6px] border-gray-400 w-full py-1.5 px-1.5 font-thin placeholder:font-normal placeholder:text-xs' placeholder='Username' />
                    ...
                    <button className='btn bg-blue-400 py-1 rounded-lg text-white'>Sign up</button>
                </form>

                <div className='shadow-lg flex flex-col gap-5 p-8 w-[350px] border'>
                    <h5 className='text-center'>Have an account? <span className='text-blue-600 hover:cursor-pointer'>Log in</span></h5>
                </div>
